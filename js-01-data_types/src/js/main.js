...
/* console.log ('Resultado de myBigInt + 1n: ${myBigInt + 1}); Nos daría un error porque solo podemos hacer operaciones con números BigInt, le faltaria una n a mi último 1*/
